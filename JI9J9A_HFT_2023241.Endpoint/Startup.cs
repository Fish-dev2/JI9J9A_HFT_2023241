...
namespace JI9J9A_HFT_2023241.Endpoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepository<Ammo>, AmmoRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "JI9J9A_HFT_2023241.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "JI9J9A_HFT_2023241.Endpoint v1"));
            }
            ...
            app.UseCors(x => x
                ...
                .AllowAnyMethod()
                .AllowAnyHeader()
                .WithOrigins("http://localhost:52541"));
